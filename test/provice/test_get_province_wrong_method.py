...
def test():
    ...
    #jadi kita sengaja salahin methodnya (negative scenario) dari hrsnya get jadi post. trs kita taro di assertnya
    #di assertnya ini kita taro status code equal to 400, jadi kalo statusnya 400 brati testnya passed
    #print(req.json())
